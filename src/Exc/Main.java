    ...
    public static void main(String[] args) throws SQLException, ClassNotFoundException, IOException {
        ...
        while (!ans.equals("9")){
            ...
            switch (Integer.parseInt(ans)){
                ...
                case 8 -> {
                    Worker exc_8 = new Worker();
                    int x = 0;
                    String check = "";
                    System.out.println("Введите название таблицы");
                    exc_8.setName_table(sc.next());
                    while (!check.equals("6")) {
                        System.out.println("""
                                1. Вывести все таблицы из базы данных MySQL.
                                2. Создать таблицу в базе данных MySQL.
                                3. Ввод с клавиатуры значения всех полей, сохранить результат в MySql и вывести в консоль.
                                4. Удалить талицу.
                                5. Сохранить результаты из MySQL в Excel и вывести их в консоль.
                                6. Выход из программы.""");
                        check = sc.next();
                        ...
                        switch (x) {
                            case 1 -> exc_8.sql_show("jdbc:mysql://localhost/Exc8");
                            case 2 -> exc_8.sql_create();
                            case 3 -> exc_8.section();
                            case 4 -> exc_8.drop("jdbc:mysql://localhost/Exc8");
